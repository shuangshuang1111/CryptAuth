...
public class UserController {
    ...
    public ResponseResult<String> changePassword(@RequestBody ChangePasswordRequest changePasswordRequest) {
        // 获取当前登录用户的用户名
        String username = getCurrentUsername();
    ...
    public ResponseResult<UserAccount> addUser(@RequestBody AddUserRequest addUserRequest) {
        try {
